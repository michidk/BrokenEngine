...
// shader output which is passed (and then interpolated) to the fragment shader
out vec3 f_position;
out vec3 f_normal;
out vec4 f_color;
...
void main()
{
	// always normalizing normals
    vec3 normal = normalize(v_normal);

	// position as vector4 ready for matrix multiplication
	...
	// convert position & normals to world space, to better calculate lightning
